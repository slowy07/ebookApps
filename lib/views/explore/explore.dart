...
import 'package:ebook_apps/components/body_builder.dart';
import 'package:ebook_apps/components/book_card.dart';
import 'package:ebook_apps/components/loading_widget.dart';
import 'package:ebook_apps/models/category.dart';
import 'package:ebook_apps/util/api.dart';
import 'package:ebook_apps/util/router.dart';
import 'package:ebook_apps/view_models/home_provider.dart';
import 'package:ebook_apps/views/genre/genre.dart';
...
class _ExploreState extends State<Explore> {
  ...
  Widget build(BuildContext context) {
    return Consumer<HomeProvider>(
      builder: (BuildContext constext, HomeProvider homeProvider, Widget child) {
        return Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(
